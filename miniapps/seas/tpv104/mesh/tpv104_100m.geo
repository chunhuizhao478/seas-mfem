// SCEC TPV104 benchmark mesh — structured Gmsh (built-in kernel), 100 m fault resolution
// Duplicated verbatim from tpv102/mesh/tpv102_100m.geo (TPV102 and TPV104
// share identical geometry; only the friction law differs).
// Process zone Lambda_dynamic ~ 160 m: h=100 m gives ~1.6 elements per Lambda (production).
//
...
//
// Usage:
//   gmsh -3 tpv104_100m.geo -o tpv104_100m.msh
...
// Hypocenter / nucleation patch (TPV104 spec: (x0,y0) = (0, 7.5 km), R = 3 km)
X_nucl     = 0e3;
...
// Physical groups — MUST match TPV104 driver defaults (bc-free=1, bc-fault=3, bc-absorb=5)
