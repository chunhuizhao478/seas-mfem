// SCEC TPV104 benchmark mesh — structured Gmsh (built-in kernel), 500 m fault resolution
// Duplicated verbatim from tpv102/mesh/tpv102_200m.geo per plan §4.10 Step 10.
