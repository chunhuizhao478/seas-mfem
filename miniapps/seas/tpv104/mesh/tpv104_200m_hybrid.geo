// SCEC TPV104 hybrid mesh: y-mirror prism strip near fault + unstructured outer
// =============================================================================
//
// Construction (matches Pelties et al. 2012 Fig. 4(a) "symmetric mesh"):
...
//
// Physical groups (must match TPV104 driver defaults):
...
// ---- Mesh size control (matches tpv104_200m.geo grading scheme) --------------
