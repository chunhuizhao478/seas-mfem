// BP5 mesh with 2x domain size for boundary truncation study.
// Domain: X in [-400, 400], Y in [-200, 200], Z in [-200, 0] km
// (2x the standard 200x100x100 km half-extents)
...
// 2x domain extents (was X0=-200, Y0=-100, Z0=-100)
X0 = -400;
X1 = -X0;
Y0 = -200;
Y1 = -Y0;
