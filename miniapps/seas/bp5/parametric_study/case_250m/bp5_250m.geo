// BP5-QD parametric study: 250m near-fault resolution
...
// Near-fault resolution: 250m (res_f=0.25)
//
...
//
// Expected: ~1.1M elements, ~160k nodes, ~52 MB mesh file
//
// Usage:
//   conda activate pythonenv
//   gmsh -3 bp5_250m.geo -o bp5_250m.msh

DefineConstant[ res =   {40, Min 0, Max 1000, Name "Far-field resolution (km)"} ];
DefineConstant[ res_f = {0.25, Min 0, Max 1000, Name "Fault resolution (km)"} ];
...
// Distance field grading from fault surface for smooth 160:1 transition
Field[1] = Distance;
Field[1].SurfacesList = {fault()};

Field[2] = Threshold;
Field[2].InField = 1;
Field[2].SizeMin = res_f;      // At fault: 0.25 km
