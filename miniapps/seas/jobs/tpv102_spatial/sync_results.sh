...
#   *.dat     (station outputs — e.g. tpv102_station_flt_0_7.5.dat)
#
# Not transferred:
...
REMOTE_ROOT="/scratch2/10024/zhaochun/seas-project/seas-mfem-heterogeneous-riemann-solver/miniapps/seas/tpv102"
DEFAULT_DEST="$HOME/Downloads/seas-mfem/tpv102_spatial"
...
# directory name (no path) like "results_spatial_dyn_200m_p1_O2_dev_job7736493".
