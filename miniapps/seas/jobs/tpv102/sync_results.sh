#!/bin/bash
# =============================================================================
# Pull TPV102 Phase 6 result files from Frontera into a local archive tree.
#
...
#
# Default destination:
#   $HOME/Downloads/seas-mfem/tpv102
...
#   ./sync_results.sh --dest /Volumes/SSD/seas/tpv102
...
REMOTE_ROOT="/scratch2/10024/zhaochun/seas-project/seas-mfem-paraview-compaction/miniapps/seas/tpv102"
DEFAULT_DEST="$HOME/Downloads/seas-mfem/tpv102"
...
# directory name (no path) like "results_phase6_zfp_dev_job7708789".
