#!/bin/bash
# =============================================================================
# Pull TPV104 SPATIAL dynamic-rupture result files from Frontera into a local
...
# For TPV104 the dev/prod jobs name it  out_rk45_mf_<jobid>  (and out_<jobid>
...
#
# Default destination:
#   $HOME/Downloads/seas-mfem/tpv104_spatial
#   ( `_spatial` suffix keeps these separate from the temporal-driver archive
#     at $HOME/Downloads/seas-mfem/tpv104 written by jobs/tpv104/sync_results.sh )
...
#   ./sync_results.sh --dest /Volumes/SSD/seas/tpv104_spatial
#   ./sync_results.sh --host zhaochun@frontera.tacc.utexas.edu
#   ./sync_results.sh --remote-root /scratch2/.../miniapps/seas/tpv104   # non-default checkout
#
