#!/bin/bash
# =============================================================================
# Pull TPV104 spatial-dyn STATION data files from Frontera into a local
# archive tree.
#
...
#   *.dat     (station outputs — e.g. tpv104_station_x2_0_x3_7.5.dat)
#
# Not transferred:
...
REMOTE_ROOT="/scratch2/10024/zhaochun/seas-project/seas-mfem-heterogeneous-riemann-solver/miniapps/seas/tpv104"
DEFAULT_DEST="$HOME/Downloads/seas-mfem/tpv104_spatial"
