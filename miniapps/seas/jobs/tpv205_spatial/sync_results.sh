#!/bin/bash
# =============================================================================
# Pull TPV205 SPATIAL dynamic-rupture result files from Frontera into a local
...
# For TPV205 the dev/prod jobs name it  out_rk45_mf_<jobid>  (and out_<jobid>
...
#
# TPV205 is LSW (slip-weakening), not rate-state; the on-fault rupture-front /
# slip-rate history lives in the fault VTU.
#
...
#   ./sync_results.sh --remote-root /scratch2/.../miniapps/seas/tpv205   # non-default checkout
#
