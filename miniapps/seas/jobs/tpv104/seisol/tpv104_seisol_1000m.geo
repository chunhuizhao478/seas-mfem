// SCEC TPV104 SeisSol mesh, 1000 m fault resolution — paired with MFEM
// `tpv104/mesh/tpv104_1000m.geo`.  *** COARSE DEBUG-ONLY MESH ***
// Λ_dyn ≈ 160 m → h/Λ ≈ 6.25, process zone marginally resolved.  Use for
// cheap dev / build-banner runs only; never for SCEC benchmark comparison.
//
// Build flow:
//   gmsh -3 -optimize tpv104_seisol_1000m.geo -o tpv104_seisol_1000m.msh
//   pumgen -s msh2 tpv104_seisol_1000m.msh tpv104_seisol_1000m
//
// SeisSol PhysicalSurface convention: 101 free / 103 fault / 105 absorbing.
// (MFEM's paired .geo uses 1/3/5; otherwise byte-identical geometry.)
//
//
...
//
// Usage:
//   gmsh -3 tpv104_1000m.geo -o tpv104_1000m.msh
