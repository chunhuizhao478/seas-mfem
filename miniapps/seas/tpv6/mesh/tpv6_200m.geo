...
// free surface.  200 m near-fault resolution (FIRST-PASS; 100 m for production).  STANDARD (asymmetric)
...
//   gmsh tpv6_200m.geo -3 -format msh22 -o tpv6_200m.msh
// (msh22 REQUIRED — the MFEM reader is Gmsh v2.2-only; see CLAUDE.md.)

// ----------------------------------------------------------------------
// Mesh-size parameters
// ----------------------------------------------------------------------
lc_fault = 200.0;           // 200 m near the fault (first-pass; spec is 100 m)
