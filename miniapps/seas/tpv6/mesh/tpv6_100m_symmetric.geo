...
// outer.  Arm 1 (matrix + UPWIND + ADER) mesh.  Adapted from tpv31/mesh/
...
//   gmsh -format msh22 -3 tpv6_100m_symmetric.geo -o tpv6_100m_symmetric.msh
...
lc_fault = 100.0;     // near-fault size (TPV6/7 spec)
...
N_strip_y = 5;
h_strip   = N_strip_y * lc_fault;     // 500 m (5 layers of 100 m)
