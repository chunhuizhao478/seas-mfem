...
PREVIEW_G1G2 = (f"{ROOT}/data_projected/preview/"
                "projected_velocity_500m_g1g2/Cycle000000/proc000000.vtu")
PREVIEW_G1G2_CROM = (f"{ROOT}/data_projected/preview/"
                     "projected_velocity_500m_g1g2_catmull/Cycle000000/"
                     "proc000000.vtu")
PREVIEW_BASELINE_CROM = (f"{ROOT}/data_projected/preview/"
...
OUT = f"{ROOT}/data_projected/comparison_baseline_vs_g1g2_z1km.png"
