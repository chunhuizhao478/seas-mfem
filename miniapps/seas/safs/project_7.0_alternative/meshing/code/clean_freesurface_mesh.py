...
Batch:
    ...
    # processes every *_unclipped.stl in ../raw/ and writes
    # cleaned STLs to ../results/stl_cleaned/<basename>_clean_<method>.stl.
"""
...
def _batch(here: Path, method: str, iterations: int,
           reproject: bool) -> int:
    """Process every *_unclipped.stl in ../raw/ and write
    cleaned outputs to ../results/stl_cleaned/<base>_clean_<method>.stl."""
    project = here.parent
    in_dir = project / "raw"
    out_dir = project / "results" / "stl_cleaned"
...
def main() -> int:
    ...
    ap.add_argument("--batch", action="store_true",
                    help="process every *_unclipped.stl in "
                         "../raw/ and write to "
                         "../results/stl_cleaned/, ignoring INPUT/OUTPUT "
                         "positional args")
    args = ap.parse_args()
