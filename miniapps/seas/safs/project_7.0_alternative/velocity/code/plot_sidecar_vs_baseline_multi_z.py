...
PREVIEW_LCFAR5K = (f"{ROOT}/velocity/results/cvmh/preview/"
                    "projected_velocity_500m_lcfar5000/Cycle000000/proc000000.vtu")
PREVIEW_LCFAR3K = (f"{ROOT}/velocity/results/cvmh/preview/"
                    "projected_velocity_500m_lcfar3000/Cycle000000/proc000000.vtu")
PREVIEW_ZGRADED = (f"{ROOT}/velocity/results/cvmh/preview/"
...
def main():
    ...
    for d_km_pos in DEPTHS_KM:
        ...
        for fname, (h5key, vtu_key, vmax_val, vmax_err, units) in \
                FIELD_CONFIG.items():
            out = (f"{ROOT}/velocity/results/cvmh/pngs/"
