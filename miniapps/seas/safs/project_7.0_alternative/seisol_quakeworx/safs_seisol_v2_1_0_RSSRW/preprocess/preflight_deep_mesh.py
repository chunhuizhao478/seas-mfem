#!/usr/bin/env python3
"""Phase 0 pre-flight for porting the RSSRW SeisSol case to the new multi-strand
...
# this script lives in safs_seisol_v2_1_0_RSSRW/preprocess/ -> 4 levels up to safs/
