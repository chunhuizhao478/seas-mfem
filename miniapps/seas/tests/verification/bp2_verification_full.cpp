...
int main(int argc, char *argv[])
{
   ...
   std::string output_prefix = "bp2_full";
   ...
   // 1200 years in seconds (~5-6 earthquake cycles)
   double t_final = 1200.0 * BP2Params::seconds_per_year;
   ...
   // Track earthquake end times (no early termination for full run)
