...
// ===========================================================================
// Phase 10 (TPV31): MakeDepthProfile1DMaterial.  Ported verbatim from hrs-ref
// `dynamic/heterogeneous_material.cpp`.
// ===========================================================================
   ...
   char depth_axis)
{
   ...
   // Coordinate-only evaluator for callsites that need per-point material
   // without an ElementTransformation.  Reuses the same eval_at_depth +
   // axis_value_to_depth lambdas as the three FunctionCoefficient instances
   // above, so values are identical by construction.
   wrapper->eval_at_xyz =
      [eval_at_depth, axis_idx, axis_value_to_depth]
