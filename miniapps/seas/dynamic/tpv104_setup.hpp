...
#include "tpv104_stations.hpp"   // TPV104Station / DefaultStations_TPV104 / FindNearestDOF_TPV104 / TPV104StationWriter (extracted)
...
// -------------------------------------------------------------------------
// On-fault station output (TPV104Station, DefaultStations_TPV104,
// FindNearestDOF_TPV104, TPV104StationWriter) lives in the lean
// `tpv104_stations.hpp`, re-included at the top of this file so the native
